<template>
  <div class="flex gap-2 items-center content-center justify-end nowrap flex-nowrap">
    <button @click="copySettingsUrl()" :disabled="copied" class="inline-flex items-center gap-1">
